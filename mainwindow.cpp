...
QString zoomStyle = "QSlider::groove:horizontal {"
...
MainWindow::MainWindow(QWidget * parent) : QMainWindow(parent) {
    ...
    this->setWindowTitle("AVL TREE VISUALIZATION");
    ...
    auto presentType = new QLabel("Type:");
    ...
    insertLineEdit->setPlaceholderText("ENTER NUMBERS");
    ...
    clearAllPushButton->setText("Clear");
    ...
    auto elementsCntLegendLabel = new QLabel("Number of elements: ");
...
void MainWindow::vertexListAdd() {
    ...
    while (ss >> s) {
        ...
        if (len > 15 || stoll(s) > INT_MAX) {
            QMessageBox msgBox;
            msgBox.setText("Your number " + QString::fromStdString(s) + " is out of range INT type");
            msgBox.exec();
            continue;
        }
        int64_t key = stoll(s);
